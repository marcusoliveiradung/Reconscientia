...
class Voluntario_ou_Associado(models.Model):
    ...
    #work_team_extra = models.ManyToManyField(Agenda, blank='True', null='True') 
...
class Fase(models.Model): 
    ...
    fase_sup = models.ForeignKey('self', blank= 'True', null='True')
    def __unicode__(self):
        return self.nome
...
class Agenda(models.Model):
    ...
    agenda_sup = models.ForeignKey('self', related_name='agenda_sup_self',blank= 'True', null='True') 
    area_rel = models.ManyToManyField(Area,blank= 'True', null='True')
    projeto_rel = models.ManyToManyField(Projeto,blank= 'True', null='True') 
    #work_team_extra = models.ManyToManyField(Voluntario_ou_Associado, through='Participacao') 
...
#    vol_ou_assoc = ForeignKey(Voluntario_ou_Associado)
#    agenda_id = 
